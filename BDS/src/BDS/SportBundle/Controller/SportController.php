...
use BDS\SportBundle\Form\SportEditType;
use BDS\SportBundle\Form\SportType;
use BDS\ImageBundle\Entity\Image;
use BDS\ImageBundle\Form\ImageLieeType;
use BDS\SportBundle\Form\PresentationType;
use BDS\SportBundle\Form\motCapitaineType;
...
class SportController extends Controller
{
	public function addAction(Request $request)
	{
		...
		return $this->render('BDSSportBundle:Sport:add.html.twig', array(
	...
	public function deleteAction( Sport $sport)
	{
		...
		return $this->render('BDSSportBundle:Sport:delete.html.twig', array(
				'domaine' => $domaine,
				'sport' => $sport
		));
	...
	public function viewAction( Sport $sport)
	{
		...
		//on affiche le sport
		return $this->render('BDSSportBundle:Sport:view.html.twig', array(
				'sport' => $sport,
				'domaine' => $domaine
		));
	}
	...
	public function listAction ()
	{
		...
		//on passe à la vue
		return $this->render('BDSSportBundle:Sport:list.html.twig', array(
				'domaine'	=>	$domaine,
				'listSport'=>	$listSport
		));
	...
	public function equipeAction (Sport $domaine)
	{
		...
		//on passe à la vue
		return $this->render('BDSSportBundle:Sport:equipe.html.twig', array(
				'domaine'		=>	$domaine,
	...
	public function presentationAction (Sport $domaine)
	{
		...
		//on passe à la vue
		return $this->render('BDSSportBundle:Sport:presentation.html.twig', array(
				'domaine'	=>	$domaine
		));
	}
	...
	public function presentationEditAction (Sport $domaine, Request $request)
	{
		...
		return $this->render('BDSSportBundle:Sport:presentationEdit.html.twig', array(
				'domaine' => $domaine,
				'form'	=> $form->createView()
		));
	}
	...
	public function motCapitaineAction (Sport $domaine)
	{
		...
		return $this->render('BDSSportBundle:Sport:motCapitaine.html.twig', array(
				'domaine' => $domaine
		));
	}
	...
	public function motCapitaineEditAction (Sport $domaine, Request $request)
	{
		...
		//on passe le formulaire à la vue
		return $this->render('BDSSportBundle:Sport:motCapitaineEdit.html.twig', array(
				'domaine' => $domaine,
				'form'	=> $form->createView()
		));
	...
	public function CapitaineEquipeAction (Sport $domaine)
	{
		...
		//on passe à la vue
		return $this->render('BDSSportBundle:Sport:capitaineEquipe.html.twig', array(
				'domaine'		=>	$domaine,
				'listMembre'	=>	$listMembre
		));
	}
